...
function AddToCart({ stockAvaibility, loading = false, error,buyNow }) {
  return (
      ...
      <div className="mt-4">
        {stockAvaibility === true && (
          ...
          <Button
            ...
            onAction={() => {
              console.log('buy now');
              document.getElementById('productForm').action = buyNow;
...
export default function ProductForm({ product, action,buyNow }) {
...
export const query = `
  query Query {
    ...
    buyNow:url (routeId: "createBuyIntent")
  }
`;
